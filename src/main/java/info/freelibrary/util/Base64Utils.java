...
/**
 * <p>
 * Encodes and decodes to and from Base64Utils notation.
 * </p>
 * <p>
 ...
 * I've got Base64Utils set the opposite way so that you tell it _not_ to add line
 ...
 * </p>
 * <p>
 * The constants defined in Base64Utils can be OR-ed together to combine options, so
 * you might make a call like this:
 * </p>
 * <code>String encoded = Base64Utils.encodeBytes( mybytes, Base64Utils.GZIP | Base64Utils.DONT_BREAK_LINES );</code>
 * <p>
 ...
 * encoding/decoding from one file to the next. Also added these Base64Utils
 * dialects:
 * <ol>
 ...
 * the new Base64Utils dialects.</li>
...
public class Base64Utils {
	...
	/**
	 * Encode using Base64Utils-like encoding that is URL- and Filename-safe as
	 ...
	 * data encoded this way is <em>not</em> officially valid Base64Utils, or at the
	 * very least should not be called Base64Utils without also specifying that is
	 * was encoded using the URL- and Filename-safe dialect.
	 */
	public final static int URL_SAFE = 16;

	/**
	 * Encode using the special "ordered" dialect of Base64Utils described here: <a
	...
	/**
	 * Translates a Base64Utils value to either its 6-bit reconstruction value or a
	 ...
	 * returns a four-byte array in Base64Utils notation. The actual number of
	 ...
	 * resulting four Base64Utils bytes to <var>destination</var>. The source and
	...
	/**
	 * Performs Base64Utils encoding on the <code>raw</code> ByteBuffer, writing it
	...
	/**
	 * Serializes an object and returns the Base64Utils-encoded version of that
	 * serialized object.
	 * <p>
	 ...
	 * <p>
	 * Example:
	 * <code>encodeObject( myObj, Base64Utils.GZIP | Base64Utils.DO_BREAK_LINES )</code>
	 * 
	 * @param serializableObject The object to encode
	...
	/**
	 * Encodes a byte array into Base64Utils notation. Does not GZip-compress data.
	 * 
	 ...
	 * <p>
	 * Example:
	 * <code>encodeBytes( myData, Base64Utils.GZIP | Base64Utils.DO_BREAK_LINES )</code>
	 * <p>
	...
	public static byte[] decode(byte[] source, int off, int len, int options)
		...
		if (len == 0) {
			...
			throw new IllegalArgumentException(
					"Base64Utils-encoded string must have at least four characters, but length specified was "
							+ len);
		} // end if
		...
		for (i = off; i < off + len; i++) { // Loop through source
			...
			if (sbiDecode >= WHITE_SPACE_ENC) {
				...
				throw new java.io.IOException(String.format(
						"Bad Base64Utils input character '%c' in array position %d",
						source[i], i));
			} // end else:
	...
	/**
	 * Decodes data from Base64Utils notation, automatically detecting
	...
	/**
	 * Attempts to decode Base64Utils data and deserialize a Java Object within.
	 ...
	 * to/from Base64Utils notation on the fly.
	 * 
	 * @see Base64Utils
	 * @since 1.3
	 */
	public static class InputStream extends java.io.FilterInputStream {
		...
		/**
		 * Constructs a {@link Base64Utils.InputStream} in either ENCODE or DECODE
		 * mode.
		 * <p>
		 * Valid options:
		 * 
		...
		/**
		 * Reads enough of the input stream to convert to/from Base64Utils and
		...
		public int read() throws java.io.IOException {
			...
			if (position < 0) {
				...
				// Else decoding
					...
					if (i == 4) {
						...
						throw new java.io.IOException(
								"Improperly padded Base64Utils input.");
					} // end
			...
			// Else error
				...
				throw new java.io.IOException(
						"Error in Base64Utils code reading stream.");
			} // end else
		} // end read
	 ...
	 * encode/decode to/from Base64Utils notation on the fly.
	 * 
	 * @see Base64Utils
	 * @since 1.3
	 */
	public static class OutputStream extends java.io.FilterOutputStream {
		...
		/**
		 * Constructs a {@link Base64Utils.OutputStream} in either ENCODE or DECODE
		 * mode.
		 * <p>
		 * Valid options:
		 * 
		...
		/**
		 * Writes the byte to the output stream after converting to/from Base64Utils
		...
		public void write(int theByte) throws java.io.IOException {
			...
			// Else, Decoding
				...
				if (decodabet[theByte & 0x7f] > WHITE_SPACE_ENC) {
					...
					throw new java.io.IOException(
							"Invalid character in Base64Utils data.");
		...
		public void flushBase64() throws java.io.IOException {
			if (position > 0) {
				if (encode) {
					...
					throw new java.io.IOException(
							"Base64Utils input not properly padded.");
				} // end else: decoding
