...
public class PairtreeObject extends File {
    ...
    private static final XMLResourceBundle BUNDLE = (XMLResourceBundle) ResourceBundle
	    .getBundle("FreeLib-Utils_Messages", new XMLBundleControl());
     ...
     * 
     * @param aRoot
     *            An existing Pairtree structure
     * @param aName
     *            The name of the Pairtree object
     * @throws IOException
     *             If there is a problem creating the Pairtree structure
     */
     ...
     * @param aPrefix
     *            A Pairtree prefix to use when creating the directory structure
     * @param aName
     *            The name of the Pairtree object to create
     * @throws IOException
