...
/**
 * An XQuery extension wrapper of some file utilities that throw exceptions.
...
public class Files {
    ...
    /**
     * Outputs an XML representation of a directory structure using a regular
     * expression to indicate what types of files should be included in the
     * output.
     * 
     * @param aDir A directory we want to use as the root in our XML file
     * @param aPattern A regular expression that will match files in the
     *        directory
